...
Animator.prototype._ctor = function()
{
  ...
  this.motion_speed = 2.5;
  this.target_motion_speed = 2.5;
...
Animator.prototype.applyBehaviour = function( behaviour )
{
  ...
  for(var j = 0; j < this.merge_animations.length; j++)
  {
    ...
    for(var k = 0; k < behaviour.animations_to_merge.length; k++)
    {
      var b_anim = behaviour.animations_to_merge[k];
      if(a_anim.anim_name == b_anim.anim)
        in_behaviour = true; 
      else{
