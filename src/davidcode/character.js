...
Character.prototype._ctor = function()
{
    ...
    this.skeleton = null;
    this.animator = null;
    this.state = {age:20, target: null, in_target:false, position:null, has_umbrella:false, has_smartphone:false, attitude:50};
    this.btree = null;
    ...
    this.path = [{pos:[0,0,0],visited:false}, {pos: [0,0,1400],visited:false}, 
...
Character.prototype.moveTo = function(target)
{
    ...
    direction = vec3.multiply(direction, direction, [this.animator.speed*this.animator.motion_speed, this.animator.speed*this.animator.motion_speed, this.animator.speed*this.animator.motion_speed]);
