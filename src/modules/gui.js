...
class GUI{
    ...
    showPopulateDialog(){
        ...
        if(!this.populate_inspector){
            ...
            populate_inspector.on_refresh = function()
            {
                ...
                var min_age = 1;
                var max_age = 100;
                populate_inspector.addNumber("Number of agents",1, {name_width:"40%", step:1, min:1, max:50, precision:0, callback:function(v)
                {
                    num_agents = v;
                }}); 
    ...
    showLoadBehaviorsDialog()
    {
        ...
        function inner_selected( item )
		{
			...
			var html = "<div class='load-icon' style='height:260px; background-size: cover;background-image: url(\"src/assets/bticon.png\")'></div><span class= 'load-behavior-info' style='font-size:1.2em'>Nodes: 38</span></br><span class= 'load-behavior-info' style='font-size:1.2em'>Description: Street with some interest points set</span>";
			root.innerHTML = html;
		}
